...
#define NEXOS_HAL_GPIO_H_VERSION "2.5.0"
#define NEXOS_HAL_GPIO_H_MAGIC   0x584F5300

typedef enum {
    NEXOS_HAL_GPIO_STATUS_OK = 0,
    NEXOS_HAL_GPIO_STATUS_ERROR = -1,
    NEXOS_HAL_GPIO_STATUS_BUSY = -2,
    NEXOS_HAL_GPIO_STATUS_TIMEOUT = -3,
    NEXOS_HAL_GPIO_STATUS_PARAM_ERR = -4,
    NEXOS_HAL_GPIO_STATUS_NO_MEM = -5
} nexos_hal_gpio_status_t;
