/**
 * NexusCRM Server - Serves backend/src/public/index.html with zero template literal escaping issues
 */
...
const server = http.createServer((req, res) => {
  ...
  try {
    ...
    res.end('Server Error: Unable to read index.html - ' + err.message);
  }
});
